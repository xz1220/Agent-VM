...
> 最后更新：2026-05-06（v19 — 收敛为 run-only 与 default Environment）
...
- Agent 删除、重命名等 P0 流程不应因为 Environment 而复杂化。
...
- Memory 原则被重新定义，并且不会破坏 Agent 的清晰心智。
